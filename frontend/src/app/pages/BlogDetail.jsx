...
export default function BlogDetail() {
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      const otherBlogs = allBlogs.filter(b => b.id !== parseInt(id));
      
      // Get chronological posts for "Keep Reading"
...
const handleDelete = () => {
  if (window.confirm("Are you sure you want to delete this blog post?")) {
    blogService.deleteBlog(parseInt(id));
    ...
    <main className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 max-w-[1000px] mx-auto">
        ...
        <div className="lg:col-span-9">
          ...
          {/* Social Sharing */}
          <SocialSharing likes={blog.likes} />
